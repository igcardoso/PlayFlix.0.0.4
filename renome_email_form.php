...
<body>
  <header id="header">
    ...
    ?>
    <form id="form" action="renomear_email.php" method="POST">
      <li style="display: none;" class="input"><input required="required" type="email" name="nome" id="email" value="<?php echo $_SESSION['nome']; ?>" /></li>
      <br>
      <br>
      ...
      <br>
      <br>
      <li class="input"><input required="required" placeholder="Novo e-mail" type="text" name="email" id="novoEmail"/></li>

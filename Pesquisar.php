...
<body>
  <header id="header">
    ...
    <form id="form" action="Pesquisar.php" method="get">
      <li class="input"><input value="<?php echo $_GET['busca']; ?>" required="required" placeholder="Busque por séries, filme, gênero etc." type="text" name="busca" id="busca" /></li>
    ...
    if (count($resultados)) {
      ...
      <br>
      <br>
      <h1 id="erro" style="color: white;">Não foram encontrados resultados.</h1>
